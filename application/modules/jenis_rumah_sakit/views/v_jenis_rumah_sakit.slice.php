...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Jenis Rumah Sakit</h2>
                    <?php if($privileges[0] == 1): ?>
                        <div class="navbar-right">
                            <a href="<?=base_url('jenis_rumah_sakit/add')?>">
                ...
                <div class="x_content">
                    <table class="table table-bordered table-striped" id="myTable">
                        ...
                        <tbody>
                            <?php $i = 1 ; foreach($jenis_rumah_sakit as $key => $value):?>
                            <tr>
                                <td><?= $i++ ?></td>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right" style="right: 0; left: auto;">
                                                    <?php if($privileges[1] == 1): ?>
                                                        <li>
                                                            <a href="<?=base_url('jenis_rumah_sakit/update/'.encode($value['id']))?>">
